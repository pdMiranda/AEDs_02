...
class ArvoreBinaria {
   ...
   public int getAltura(No i, int altura){
	 ...
	 * @throws Exception Se nao encontrar elemento.
	 */
	private void remover2(char x, No i, No pai) throws Exception {
		if (i == null) {
         throw new Exception("Erro ao remover2!");
      } else if (x < i.elemento) {
         remover2(x, i.esq, i);
    ...
    public static void main(String[] args) throws Exception{
        ...
        try {
            while((linha = sc.nextLine()) != null){
                if(linha.charAt(0) == 'I'){
                ...
                else if(linha.charAt(0) == 'P'){
                    if(linha.compareTo("PREFIXA") == 0){
                        arvore.caminharPre();
                    }
                        ...
                        if(arvore.pesquisar(linha.charAt(2))){
                    ...
                    System.out.println("ERRO EM" + linha);
                }
            }
