...
public class TP05Q08{
    public static void main(String[] args) throws Exception {
        ...
        String[] resolve2 = resolve.split(" ");
        
        int casos = Integer.parseInt(resolve2[0]);
        ...
        for(int i = 0; i < casos; i++){
            ...
            resolve = sc.nextLine();
            resolve2 = resolve.split(" ");
            int quantidade = Integer.parseInt(resolve2[0]);

            numeros = sc.nextLine();
            String[] numeros2 = numeros.split(" ");

            for(int j = 0; j < numeros2.length; j++){
                arvore.inserir(Integer.parseInt(numeros2[j]));
            }
